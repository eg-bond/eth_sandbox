...
contract('DEFI_AI_FARM', accounts => {
  ...
  it.skip('getTotalBalance works properly', async () => {
    ...
    await busd.approve(FARM_ADDR, 5000000, { from: BUSD_WHALE })
    const allowed = await busd.allowance(
      '0xf89d7b9c864f589bbf53a82105107622b35eaa40',
      FARM_ADDR
    )
    console.log(`allowed: ${allowed}`)

    await farm.deposit(0, 500005, { from: BUSD_WHALE })
  ...
  it('withdrawal can be hacked', async () => {
    ...
    await farm.withdraw(0, 5000000, {
      from: '0xd88E75b4f3A869B0b56d34f2364dfCe26386a00C',
    })
    // await farm.withdraw(0, 5000000000000000, {
    //   from: '0xd88E75b4f3A869B0b56d34f2364dfCe26386a00C',
    // })
  ...
  it.skip('allowances for hacker addresses was set initially (inside hack)', async () => {
    ...
    // for block 18543477 (then contract was just created) all allowances is 0

    // for block 20564820 (90 days from hack) all allowances is 0

    // for block 23012500 allowance for 0xd88E75b4f3A869B0b56d34f2364dfCe26386a00C was 5000...000

    // 23012469 - first 2 addr
